        ...
        <View style={stylesheet.card}>
          ...
          <View style={stylesheet.summaryGrid}>
            <View style={stylesheet.summaryItem}>
              <Text
                style={[stylesheet.summaryNum, { color: colors.primary }]}
              >
                {total}
              </Text>
            ...
            <View style={stylesheet.summaryItem}>
              <Text
                style={[stylesheet.summaryNum, { color: colors.success }]}
              >
                {present}
              </Text>
            ...
            <View style={stylesheet.summaryItem}>
              <Text
                style={[stylesheet.summaryNum, { color: colors.error }]}
              >
                {absent}
              </Text>
            ...
            <View style={stylesheet.summaryItem}>
              <Text
                style={[stylesheet.summaryNum, { color: colors.warning }]}
              >
                {late}
              </Text>
